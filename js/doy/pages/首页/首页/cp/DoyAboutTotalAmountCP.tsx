  ...
  return (
    <AnimationFadeView show={v.show} backgroundColor='#00000077'>
      <View style={{ width: AppDefine.width - 55, backgroundColor: '#fff', borderRadius: sc(4), overflow: 'hidden', padding: sc(24) }}>
        <Text style={{ fontSize: sc(20), fontWeight: '500' }}>关于总资产</Text>
        <Text style={{ fontSize: sc(12), color: '#585A5E', lineHeight: sc(18) }}>{`
...
【担保数量】
因兑换BTC、挂单出售等等，为使交易顺畅，暂且无法使用的币。您可藉由取消兑换、取消挂单等解冻。`}</Text>
