    ...
    try {
        if (getCurrentPage() == Navigation_1.PageName.TransitionPage) {
            ...
            if (action == Router_1.RouterType.Stack) {
                ...
                popToRoot();
                (_d = exports.navigationRef === null || exports.navigationRef === void 0 ? void 0 : exports.navigationRef.current) === null || _d === void 0 ? void 0 : _d.dispatch(native_1.TabActions.jumpTo(Navigation_1.PageName.TransitionPage, { jumpTo: page, props: props }));
            }
        }
    }
    catch (e) {
