...
var LCPages = [
    ...
    },
    {
        // 登录
        vcName: 'UGLoginViewController',
        rnName: Navigation_1.PageName.LCLoginPage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
    {
        // 注册
        vcName: 'UGRegisterViewController',
        rnName: Navigation_1.PageName.LCRegisterPage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
...
var WNSPages = [
    ...
    },
    {
        ...
        tabbarItemPath: '/lotteryList',
        vcName: 'UGYYLotteryHomeViewController',
        rnName: Navigation_1.PageName.WNZGameLobbyPage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: false,
    }
...
var KSPages = [
    ...
    },
    {
        // 注册
        vcName: 'UGRegisterViewController',
        rnName: Navigation_1.PageName.KSRegister,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
    {
        ...
        tabbarItemPath: '/user',
        vcName: 'UGMineSkinViewController',
        rnName: Navigation_1.PageName.KSMine,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: false,
    },
...
var JXHPages = [
    {
        // 首页
        tabbarItemPath: '/home',
        rnName: Navigation_1.PageName.GDBHomePage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
    {
        // 登录
        vcName: 'UGLoginViewController',
        rnName: Navigation_1.PageName.GDLoginPage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
    {
        // 注册
        vcName: 'UGRegisterViewController',
        rnName: Navigation_1.PageName.GDRegisterPage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: true,
    },
    {
        ...
        tabbarItemPath: '/user',
        vcName: 'UGMineSkinViewController',
        rnName: Navigation_1.PageName.GDBMinePage,
        fd_prefersNavigationBarHidden: true,
        允许游客访问: true,
        允许未登录访问: false,
    },
