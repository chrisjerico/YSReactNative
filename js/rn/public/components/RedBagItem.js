...
var RedBagItem = function (_a) {
    ...
    return (redBagVisiable ?
        react_2.default.createElement(react_native_1.TouchableWithoutFeedback, { onPress: function () {
                if (uid == "") {
            ...
            react_2.default.createElement(react_native_1.View, { style: [{ width: 120, right: 20, top: 80, position: "absolute", flexDirection: "row" }, style] },
                react_2.default.createElement(react_native_fast_image_1.default, { style: [{ width: 95, height: 95, zIndex: 100 }], source: { uri: (_b = redBag === null || redBag === void 0 ? void 0 : redBag.data) === null || _b === void 0 ? void 0 : _b.redBagLogo } }),
                react_2.default.createElement(react_native_1.TouchableWithoutFeedback, { onPress: function () {
                        setRedBagVisiable(false);
                    } },
                    react_2.default.createElement(react_native_1.Image, { style: { width: 25, height: 25, marginLeft: 10 }, source: { uri: "dialog_close" } })))) : react_2.default.createElement(react_2.default.Fragment, null));
};
exports.default = RedBagItem;
//# sourceMappingURL=RedBagItem.js.map