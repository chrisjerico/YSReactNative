...
var Avatar_1 = __importDefault(require("../../views/tars/Avatar"));
var ProgressCircle_1 = __importDefault(require("../../views/tars/ProgressCircle"));
var PickAvatarComponent = function (_a, ref) {
    ...
    return (react_1.default.createElement(react_native_1.Modal, { transparent: true, visible: visible },
        react_1.default.createElement(react_native_1.View, { style: styles.container },
            react_1.default.createElement(react_native_1.View, { style: styles.pickerBlock },
                react_1.default.createElement(react_native_1.View, { style: styles.avatarContainer },
                    react_1.default.createElement(Avatar_1.default, { uri: avatar, size: 200 }),
                    react_1.default.createElement(react_native_1.Text, { style: { marginTop: Scale_1.scale(10) } }, '头像预览')),
                loading ? (react_1.default.createElement(ProgressCircle_1.default, null)) : (react_1.default.createElement(react_native_1.View, { style: { flex: 1, flexDirection: 'row', alignItems: 'center' } },
                    react_1.default.createElement(AntDesign_1.default, { name: 'left', color: '#9D9D9D', size: Scale_1.scale(30), style: { paddingHorizontal: Scale_1.scale(10) }, onPress: function () { return scrollView.current.scrollTo({ x: 0, y: 0, animated: true }); } }),
                    react_1.default.createElement(react_native_1.ScrollView, { horizontal: true, showsHorizontalScrollIndicator: false, ref: scrollView }, avatarList === null || avatarList === void 0 ? void 0 : avatarList.map(function (item, index) {
                        var url = item.url, filename = item.filename;
                        return (react_1.default.createElement(Avatar_1.default, { key: index, uri: url, size: 100, containerStyle: { marginHorizontal: Scale_1.scale(10) }, onPress: function () {
                                setAvatar(url);
                                setfileName(filename);
                            } }));
                    })),
                    react_1.default.createElement(AntDesign_1.default, { name: 'right', color: '#9D9D9D', size: Scale_1.scale(30), style: { paddingHorizontal: Scale_1.scale(10) }, onPress: function () { return scrollView.current.scrollToEnd({ x: 0, y: 0, animated: true }); } }))),
                react_1.default.createElement(react_native_1.View, { style: styles.buttonContainer },
                    react_1.default.createElement(react_native_elements_1.Button, { activeOpacity: 1, title: '保存头像', buttonStyle: {
                            backgroundColor: color,
                            width: Scale_1.scale(200),
                        }, titleStyle: { color: '#ffffff' }, onPress: function () { return saveAvatar({ url: avatar, filename: fileName }); } }),
                    react_1.default.createElement(react_native_elements_1.Button, { activeOpacity: 1, title: '取消', buttonStyle: { backgroundColor: '#D0D0D0', width: Scale_1.scale(200) }, titleStyle: { color: '#ffffff' }, onPress: function () {
                            setVisible(false);
                        } }))))));
};
...
//# sourceMappingURL=PickAvatarComponent.js.map