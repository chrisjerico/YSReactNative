...
var GameSubTypeComponent = function (_a) {
    var _b = _a.games, games = _b === void 0 ? [] : _b, renderGame = _a.renderGame, containerStyle = _a.containerStyle, renderSubType = _a.renderSubType, subTypeContainerStyle = _a.subTypeContainerStyle, numColumns = _a.numColumns, subTypeNumColumns = _a.subTypeNumColumns, _c = _a.uniqueKey, uniqueKey = _c === void 0 ? 'uniqueKey' : _c, contentContainerStyle = _a.contentContainerStyle;
    var _d, _e;
    ...
    var mainGames = sliceCount == -1 ? games : (_d = games === null || games === void 0 ? void 0 : games.slice(0, sliceCount)) !== null && _d !== void 0 ? _d : [];
    var subGames = sliceCount == -1 ? [] : (_e = games === null || games === void 0 ? void 0 : games.slice(sliceCount, games === null || games === void 0 ? void 0 : games.length)) !== null && _e !== void 0 ? _e : [];
