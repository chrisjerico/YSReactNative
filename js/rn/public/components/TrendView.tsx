...
export const TrendView = () => {
    ...
    const [defaultNumber, setDefaultNumber] = useState(`0-0`)
    ...
    const getData = () => {
        APIRouter.getTrendData(currentGame.id).then((result) => {
    ...
    return (
        <SafeAreaView style={{backgroundColor: "#ffffff", flex: 1}}>
                    ...
                    return <View key={`btnView-${index}`} style={{
                        ...
                        {item.map((text, contentIndex) => <View key={`${index}-${contentIndex}`}
                            ...
                            <TouchableOpacity style={{
                                ...
                                marginHorizontal: 2,
                                width: itemWidth,
                                backgroundColor: defaultNumber == `${index}-${contentIndex}` ? "#f39b67" : "rgba(255,255,255,0.2)"
                            }} onPress={() => {
                                setDefaultNumber(`${index}-${contentIndex}`)
                            }}>
                                <Text style={{
            ...
            <View style={{flexDirection: "row"}}>
                <TouchableOpacity style={{backgroundColor: "#d7213a", height: 44, justifyContent: "center"}} onPress={() => setShowModal(true)}>
                    <Text style={{textAlign: "center", color: "white", paddingHorizontal: 16}}>{currentGame.title}</Text>
                </TouchableOpacity>
                ...
                <ChooseGameModal setCurrentGame={setCurrentGame} setShowModal={setShowModal} showModal={showModal} />
            </View>
        </SafeAreaView>
    )
}
