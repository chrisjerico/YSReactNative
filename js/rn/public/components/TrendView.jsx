...
var TrendView = function (_a) {
    ...
    return (<BaseScreen_1.BaseScreen style={{ backgroundColor: "#ffffff" }} screenName={"开奖走势"}>
        ...
        return index == 0 ? <react_native_1.Text style={{
            ...
            width: 120,
            textAlign: "center"
        }}>期数</react_native_1.Text> :
            <react_native_1.Text key={"header-" + index} style={{
                textAlign: "center",
                ...
                color: "#ffffff",
                paddingVertical: 8
            }}>{getHeaderIndex(currentGame.gameType, index)}</react_native_1.Text>;
    })}
                            </react_native_1.View>
                        </react_native_1.View>
        ...
        return index == 0 ?
            <react_native_1.Text style={{
                ...
                width: 120,
                textAlign: "center"
            }}>{item}</react_native_1.Text> : <react_native_1.Text key={"header-" + index} style={{
            textAlign: "center",
            width: (screenWidth - 120) / 6,
            backgroundColor: "#c2adac",
            borderWidth: 0.5,
        ...
        return index != 0 &&
            <react_native_svg_1.Line x1={item.x} y1={item.y} x2={trendData === null || trendData === void 0 ? void 0 : trendData.positionArr[index - 1].x} y2={trendData === null || trendData === void 0 ? void 0 : trendData.positionArr[index - 1].y} stroke="#409fdc" strokeWidth="1"/>;
    })}
    ...
    }}>{currentGame.title}</react_native_1.Text>
                </react_native_1.TouchableOpacity>
