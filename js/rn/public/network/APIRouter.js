...
var APIRouter = /** @class */ (function () {
    ...
    */
    ...
    APIRouter.game_lotteryGames = function () { return __awaiter(void 0, void 0, Promise, function () {
        return __generator(this, function (_a) {
            //@ts-ignore
    ...
    APIRouter.game_playOdds = function (id) { return __awaiter(void 0, void 0, Promise, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, httpClient_1.httpClient.get("c=game&a=playOdds", {
                    //@ts-ignore
                    isEncrypt: true,
                    params: {
                        id: id,
