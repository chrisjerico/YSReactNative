        ...
        <View style={{ marginHorizontal: 30, marginTop: -50, backgroundColor: '#eee', alignSelf: 'center', borderRadius: 10, padding: 13 }} >
          ...
          {type == UGLoadingType.Reload && (
            <View style={{ position: 'absolute', alignSelf: 'flex-end', marginTop: -7, marginLeft: 30 }}>
              <TouchableOpacity containerStyle={[{ width: 44, height: 44 }, { overflow: 'hidden' }]}
                                onPress={hideLoading}>
                <Icon size={30} type='antdesign' name="closecircleo" color='black' containerStyle={{
                  alignSelf: 'flex-end',
                  marginRight: -7,
                  backgroundColor: '#eee',
                  borderRadius: 15,
