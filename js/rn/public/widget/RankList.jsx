...
var RankListCP = function (_a) {
    ...
    react_1.useEffect(function () {
        ...
        var value = react_native_1.Animated.loop(react_native_1.Animated.timing(currentY, {
            toValue: (_c = -1 * (((_b = (_a = ranks === null || ranks === void 0 ? void 0 : ranks.data) === null || _a === void 0 ? void 0 : _a.list) === null || _b === void 0 ? void 0 : _b.length) + 5)) !== null && _c !== void 0 ? _c : 0,
            duration: timing,
    ...
    return (<>
        <react_native_1.View style={{ flexDirection: 'column' }}>
          ...
          <react_native_1.View style={{ backgroundColor: backgroundColor, alignSelf: 'center', borderRadius: 8 }}>
            {((_c = (_b = ranks === null || ranks === void 0 ? void 0 : ranks.data) === null || _b === void 0 ? void 0 : _b.list) === null || _c === void 0 ? void 0 : _c.length) > 0 ?
        <react_native_1.View style={{ flexDirection: 'row', width: width, alignSelf: 'center', }}>
