...
var useTryPlay = function (options) {
    ...
    var tryPlay = function () { return __awaiter(void 0, void 0, void 0, function () {
        var user_guestLogin_response, user_guestLogin_data, user_guestLogin_msg, _a, error_1;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    _d.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, ANHelper_1.ANHelper.callAsync(CmdDefine_1.CMD.SAVE_DATA, __assign({ key: DataDefine_1.NA_DATA.LOGIN_INFO }, user_guestLogin_data))];
                case 5:
                    _d.sent();
                    return [3 /*break*/, 6];
                case 6: return [4 /*yield*/, IGlobalStateHelper_1.updateUserInfo()];
                case 7:
                    _d.sent();
                    onSuccess && onSuccess();
                    return [3 /*break*/, 9];
