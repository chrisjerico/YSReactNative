    ...
    var initHost = function (host) {
        ...
        if ((coustomArray === null || coustomArray === void 0 ? void 0 : coustomArray.length) > 0) {
            ...
            axios_1.default.all([
                ...
                APIRouter_1.default.system_homeAds(),
            ])
                .then(axios_1.default.spread(function () {
                ...
                setNotice((_c = res === null || res === void 0 ? void 0 : res[2]) === null || _c === void 0 ? void 0 : _c.data);
                setCouponListData((_d = res === null || res === void 0 ? void 0 : res[3]) === null || _d === void 0 ? void 0 : _d.data);
                setRankList((_e = res === null || res === void 0 ? void 0 : res[4]) === null || _e === void 0 ? void 0 : _e.data);
                setOnlineNum((_h = (_g = (_f = res === null || res === void 0 ? void 0 : res[5]) === null || _f === void 0 ? void 0 : _f.data) === null || _g === void 0 ? void 0 : _g.data) === null || _h === void 0 ? void 0 : _h.onlineUserCount);
                setOnlineSwitch((_l = (_k = (_j = res[5]) === null || _j === void 0 ? void 0 : _j.data) === null || _k === void 0 ? void 0 : _k.data) === null || _l === void 0 ? void 0 : _l.onlineSwitch);
                setRedBag((_m = res === null || res === void 0 ? void 0 : res[6]) === null || _m === void 0 ? void 0 : _m.data);
                setFloatAds((_o = res === null || res === void 0 ? void 0 : res[7]) === null || _o === void 0 ? void 0 : _o.data);
                setSystemHomeAds(res === null || res === void 0 ? void 0 : res[8].data);
                setLoading(false);
            }))
                .catch(function (err) {
                setLoading(false);
