...
var JXHMinePage = function () {
    ...
    return (<>
      <SafeAreaHeader_1.default headerColor={'#000000'}>
        <BackBtnComponent_1.default homePage={Navigation_1.PageName.JXHHomePage} renderHeader={function (props) { return <MineHeader_1.default {...props} title={'会员中心'} showRightTitle={false}/>; }}/>
