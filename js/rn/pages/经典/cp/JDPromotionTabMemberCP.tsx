...
const JDPromotionTabMemberCP = ({ pageTitle, titleArray }: { pageTitle?: string, titleArray?: Array<string>, }) => {


  let { current: v } = useRef<JDPromotionTabMemberCP>(
    {
      pageTitle: PromotionConst.会员管理,
      titleArray: ["分级777", "用户名", "在线状态", "注册时间", "下线盈亏", "操作/状态"],
      items: [],
      levelArray: [],
      pageSize: 20,
      pageNumber: 1,
...
export default JDPromotionTabMemberCP
