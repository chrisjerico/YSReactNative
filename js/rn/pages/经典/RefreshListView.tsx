...
import {View, Text, StyleSheet, FlatList, ActivityIndicator, TouchableOpacity, ViewPropTypes, ListRenderItem} from 'react-native'
...
class RefreshListView extends PureComponent<Props> {
  ...
  render() {
    ...
    let {renderItem, keyExtractor,ListEmptyComponent,onHeaderRefresh, ...rest} = this.props
