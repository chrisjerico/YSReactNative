...
exports.RecommendTabView = function (_a) {
    ...
    return (React.createElement(react_native_1.View, { style: { paddingTop: 10, flex: 1 } },
        ...
        React.createElement(react_native_1.View, { style: { marginHorizontal: 12, flex: 1 } },
            React.createElement(react_native_1.Text, { style: { color: "#3C3C3C", fontSize: 18, fontWeight: "bold", paddingVertical: 8 } }, "\u771F\u4EBA\u5A31\u4E50"),
            React.createElement(ImageButton_1.ImageButton, { imgStyle: { height: 140, resizeMode: "stretch" }, uri: (_b = list[0]) === null || _b === void 0 ? void 0 : _b.icon, onPress: function () { return onPress(list[0]); } }),
            React.createElement(ImageButton_1.ImageButton, { imgStyle: { height: 140, marginTop: 8, resizeMode: "stretch" }, uri: (_c = list[1]) === null || _c === void 0 ? void 0 : _c.icon, onPress: function () { return onPress(list[1]); } }),
            React.createElement(react_native_1.View, { style: { flexDirection: "row", marginTop: 8, flex: 1 } },
                React.createElement(ImageButton_1.ImageButton, { imgStyle: { flex: 2 / 3, height: 100, width: "auto", resizeMode: "stretch" }, uri: ((_d = list[2]) === null || _d === void 0 ? void 0 : _d.icon) || ((_f = (_e = list[2]) === null || _e === void 0 ? void 0 : _e.subType[0]) === null || _f === void 0 ? void 0 : _f.icon), onPress: function () { return onPress(list[2]); } }),
...
var Banner = function (_a) {
    ...
    if (((_d = (_c = bannerData === null || bannerData === void 0 ? void 0 : bannerData.data) === null || _c === void 0 ? void 0 : _c.list) === null || _d === void 0 ? void 0 : _d.length) > 0) {
        return (React.createElement(react_native_1.View, { style: { marginBottom: 10, } },
            React.createElement(react_native_banner_carousel_1.default, { autoplay: true, index: 0, ref: BannerRef, loop: true, pageSize: width }, (_f = (_e = bannerData === null || bannerData === void 0 ? void 0 : bannerData.data) === null || _e === void 0 ? void 0 : _e.list) === null || _f === void 0 ? void 0 : _f.map(function (res, index) {
                return (React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: function () {
                    ...
                    React.createElement(react_native_fast_image_1.default, { onLoad: function (e) {
        ...
        return React.createElement(react_native_1.View, { style: { height: (react_native_1.Dimensions.get("screen").width) / 2, } });
    }
};
//# sourceMappingURL=RecommendTabView.js.map