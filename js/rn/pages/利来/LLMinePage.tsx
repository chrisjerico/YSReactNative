                    ...
                    <View style={{flexDirection: "row", marginHorizontal: 8, marginVertical: 16}}>
                        ...
                        <View style={{marginLeft: 12}}>
                            <View style={{flexDirection: "row", alignItems: "center"}}>
                                ...
                                <LinearGradient colors={['#FFEAC3', '#FFE09A']} start={{x: 0, y: 1}} end={{x: 1, y: 1}}
                                                style={{
                                                    marginLeft: 8,
                                                    marginTop: 1,
                                                    borderRadius: 3,
                            ...
                            <View style={{flexDirection: "row", alignItems: 'center'}}>
                                ...
                                <Text style={{color: "#ffffff", lineHeight: 20, fontSize: 14}}>{nextLevelGrade}</Text>
                            </View>
                            {levelWidth === 193 && <Text style={{color: "#ffffff", fontSize: 14}}>恭喜您已经是最高等级!</Text>}
                        </View>
                    </View>
