...
var LLHomePage = function (_a) {
    ...
    return (React.createElement(react_native_1.View, { style: { flex: 1 } },
        ...
        React.createElement(react_native_1.SafeAreaView, { style: { flex: 1 } },
            React.createElement(react_native_1.ScrollView, { refreshControl: React.createElement(react_native_1.RefreshControl, { style: { backgroundColor: "#ffffff" }, refreshing: loading, onRefresh: onRefresh }), style: { flex: 1 } },
                React.createElement(HomeHeaderButtonBar_1.HomeHeaderButtonBar, { logoIcon: mobile_logo }),
                React.createElement(HomeTabView_1.HomeTabView, null),
                m_promote_pos &&
                    React.createElement(React.Fragment, null,
                        React.createElement(react_native_1.TouchableOpacity, { style: { flexDirection: "row", alignItems: "center", marginHorizontal: 8, marginTop: 10 }, onPress: function () {
                ...
                rankingListSwitch === 1 ? React.createElement(react_native_1.SafeAreaView, { style: { marginHorizontal: 10 } },
                    React.createElement(react_native_1.View, { style: { flexDirection: "row", alignItems: "center" } },
                        React.createElement(FontAwesome_1.default, { style: { paddingRight: 4 }, size: 16, name: "bar-chart-o" }),
                    ...
                    React.createElement(RankList_1.default, { titleVisible: false, timing: 10000, backgroundColor: "white", textColor: "black", width: react_native_1.Dimensions.get("screen").width - 24, ranks: rankList })) :
                    React.createElement(react_native_1.SafeAreaView, { style: { marginHorizontal: 10 } },
                        React.createElement(react_native_1.View, { style: { flexDirection: "row", alignItems: "center" } },
                            React.createElement(FontAwesome_1.default, { style: { paddingRight: 4 }, size: 16, name: "bar-chart-o" }),
                            React.createElement(react_native_1.Text, { style: {
                                    fontSize: 16,
                        ...
                        React.createElement(RankList_1.default, { titleVisible: false, timing: 10000, backgroundColor: "white", textColor: "black", width: react_native_1.Dimensions.get("screen").width - 24, ranks: rankList })),
                React.createElement(react_native_1.View, { style: { flexDirection: "row", justifyContent: "center", marginTop: 10 } },
                    React.createElement(react_native_1.Text, { onPress: function () {
                        ...
                        }, style: { color: "black", textAlign: "center", marginRight: 20, marginBottom: 5 } }, "\uD83D\uDCBB \u7535 \u8111 \u7248"),
                    React.createElement(react_native_1.Text, { style: { color: "black", textAlign: "center" }, onPress: function () {
                            RootNavigation_1.push(Navigation_1.PageName.PromotionListPage);
                        } }, "\uD83C\uDF81\u4F18\u60E0\u6D3B\u52A8")),
        ...
        uid === "" && React.createElement(react_native_1.View, { style: {
            ...
            React.createElement(react_native_linear_gradient_1.default, { colors: ["#df4133", "#fe695b"], style: { borderRadius: 40 } },
                React.createElement(react_native_1.View, { style: { flexDirection: "row", justifyContent: "center", padding: 8 } },
                    React.createElement(react_native_1.TouchableOpacity, { style: { height: 40, justifyContent: "center", paddingHorizontal: 30 }, onPress: function () { return RootNavigation_1.navigate(Navigation_1.PageName.LLLoginPage, {}); } },
                        React.createElement(react_native_1.Text, { style: { fontSize: 20, color: "#ffffff" } }, "\u767B\u5F55")),
                    React.createElement(react_native_1.View, { style: { width: 1, backgroundColor: "#ffffff", height: 40 } }),
                    React.createElement(react_native_1.TouchableOpacity, { style: { height: 40, justifyContent: "center", paddingHorizontal: 30 }, onPress: function () { return RootNavigation_1.push(Navigation_1.PageName.LLRegisterPage); } },
                        React.createElement(react_native_1.Text, { style: { fontSize: 20, color: "#ffffff" } }, "\u6CE8\u518C"))))),
        ads.map(function (item, index) {
            ...
            return (React.createElement(ActivityComponent_1.default, { key: index, containerStyle: [tars_1.getActivityPosition(position), position % 2 != 0 ? { top: 260 } : { bottom: 260 }], enableFastImage: true, show: true, logo: image, onPress: function () {
                    PushHelper_1.default.pushCategory(linkCategory, linkPosition);
                } }));
        }),
        React.createElement(RedBagItem_1.default, { redBag: redBag, style: { top: 200 } }),
        React.createElement(TurntableListItem, null)));
};
...
var TurntableListItem = function () {
    ...
    if (turntableListVisiable && uid && uid != "") {
        return (React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: function () {
            ...
            React.createElement(react_native_1.ImageBackground, { style: { width: 95, height: 95, position: "absolute", top: height / 2, right: 20 }, source: { uri: "dzp_btn" } },
                React.createElement(react_native_1.TouchableWithoutFeedback, { onPress: function () {
                        setTurntableListVisiable(false);
                    } },
                    React.createElement(react_native_1.Image, { style: { width: 20, height: 20, right: 0, top: 0, position: "absolute" }, source: { uri: "dialog_close" } })))));
    }
    else {
        return null;
    }
};
//# sourceMappingURL=LLHomePage.js.map