...
var ZTContainer = function (_a) {
    ...
    //玩法列表
    var _b = react_1.useState([]), plays = _b[0], setPlays = _b[1];
    var _c = react_1.useState(""), currentFilter = _c[0], setCurrentFilter = _c[1];
    return (<react_native_1.ScrollView style={{ flex: 1 }}>
        ...
        if (index == 0) {
            ...
            return <HKNormalWithSBView_1.default setProps={setProps} key={res.id + index} data={res}/>;
        }
    })}
