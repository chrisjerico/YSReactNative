...
var LMAContainer = function () {
    ...
    var _c = react_1.useState(""), currentOdd = _c[0], setCurrentOdd = _c[1];
    ...
    return (<react_native_1.ScrollView style={{ flex: 1 }}>
      <react_native_1.View style={{ justifyContent: 'center', alignItems: 'center' }}>
        <react_native_1.FlatList horizontal={true} style={{}} keyExtractor={function (item) { return item; }} data={plays !== null && plays !== void 0 ? plays : []} renderItem={function (_a) {
        var item = _a.item;
      ...
      <react_native_1.Text style={{ textAlign: 'center', marginVertical: 10 }}>{currentFilter}</react_native_1.Text>
      <react_native_1.View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
        ...
        if (index < 45) {
            return (<react_native_1.TouchableWithoutFeedback onPress={function () {
                ...
                <react_native_1.View key={index} style={{ width: ((width / 4 * 3) - 5) / 3, borderWidth: 1, borderColor: '#444', height: itemSize }}>
                  <react_native_1.View style={{ flex: 1, borderWidth: 1, borderColor: '#444', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'row', backgroundColor: "#00000000" }}>
                    <react_native_1.View style={{ width: 30, height: 30, borderRadius: 15, borderColor: lottoSetting_1.getHKballColor(res < 10 ? "0" + res : res.toString()), borderWidth: 1, justifyContent: 'center', alignItems: 'center', marginHorizontal: 5 }}>
            ...
            return (<react_native_1.TouchableWithoutFeedback onPress={function () {
                ...
                <react_native_1.View key={index} style={{ width: ((width / 4 * 3) - 5) / 2, borderWidth: 1, borderColor: '#444', height: itemSize }}>
                  <react_native_1.View style={{ flex: 1, borderWidth: 1, borderColor: '#444', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'row', backgroundColor: "#00000000" }}>
                    <react_native_1.View style={{ width: 30, height: 30, borderRadius: 15, borderColor: lottoSetting_1.getHKballColor(res < 10 ? "0" + res : res.toString()), borderWidth: 1, justifyContent: 'center', alignItems: 'center', marginHorizontal: 5 }}>
                      <react_native_1.Text>{res < 10 ? "0" + res : res.toString()}</react_native_1.Text>
                    </react_native_1.View>
