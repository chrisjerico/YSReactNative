...
var HKWXItemView = function (_a) {
    ...
    return (<react_native_1.View style={{ flex: 1, flexDirection: 'row', flexWrap: 'wrap' }}>
      ...
      <react_native_1.View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
        ...
        if (index == 4) {
            return <react_native_1.View key={data.from_id + data.isBan + data.code + data.name + data.alias} style={{ width: ((width / 4 * 3) - 5), borderWidth: 1, borderColor: '#444', height: itemSize }}>
