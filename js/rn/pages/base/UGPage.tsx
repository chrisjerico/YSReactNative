...
import {
  BottomTabNavigationOptions, BottomTabNavigationProp
...
import UGNavigationBar, {
  UGNavigationBarProps
} from '../../public/widget/UGNavigationBar'
...
export default (Page: Function) => {
  return (props: UGBasePageProps) => {
    ...
    newProps.current = deepMergeProps(
      newProps.current,
      UGStore.getPageProps(route.name)
    )
