...
exports.default = (function (Page) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            ...
            return (react_1.default.createElement(react_native_linear_gradient_1.default, { colors: backgroundColor, start: { x: 0, y: 1 }, end: { x: 1, y: 1 }, style: { flex: 1 } },
                react_1.default.createElement(react_native_fast_image_1.default, { source: { uri: backgroundImage }, style: { flex: 1 } },
                    !navbarOpstions.hidden && react_1.default.createElement(UGNavigationBar_1.default, __assign({}, navbarOpstions)),
                    react_1.default.createElement(Page, __assign({}, this.newProps, { setProps: this.setProps.bind(this), vars: this.vars }))))); // navigation={this.props.navigation}
        };
        return class_1;
