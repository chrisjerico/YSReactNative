...
import OldLetteyGameListComponent from './games/OldLetteyGameListComponent'
...
const OldLetteyHallPage = ({ navigation, setProps ,route}: UGBasePageProps) => {
  ...
  const renderDataList = (item: HallGameData) =>
    <OldLetteyGameListComponent gameData={item}/>
...
export default OldLetteyHallPage
