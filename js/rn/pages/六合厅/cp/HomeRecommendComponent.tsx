 ...
 * 主页公告,信息 等等内容
 */
export default class HomeRecommendComponent extends Component<IProps> {
  /**
   * 绘制 公告,信息 等等内容
   * @private
   */
  ...
  render(): React.ReactNode {
    return (
      <View style={{ width: '100%', aspectRatio: 540 / 570, backgroundColor: '#ffffff', borderRadius: 15 }}>
...
const defaultNotice = [{
  "content": "公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告公告"
}]
