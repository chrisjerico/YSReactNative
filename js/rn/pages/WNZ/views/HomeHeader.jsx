...
var HomeHeader = function (_a) {
    var name = _a.name, logo = _a.logo, balance = _a.balance, onPressMenu = _a.onPressMenu, onPressComment = _a.onPressComment, onPressUser = _a.onPressUser, _b = _a.showBackBtn, showBackBtn = _b === void 0 ? false : _b, uid = _a.uid;
    return (<react_native_1.View style={styles.container}>
      ...
      {!showBackBtn && (<react_native_1.View style={styles.rightContainer}>
