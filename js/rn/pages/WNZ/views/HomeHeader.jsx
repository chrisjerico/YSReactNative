...
var HomeHeader = function (_a) {
    var name = _a.name, logo = _a.logo, balance = _a.balance, onPressMenu = _a.onPressMenu, onPressComment = _a.onPressComment, onPressUser = _a.onPressUser, uid = _a.uid, onPressBackBtn = _a.onPressBackBtn;
    ...
    return (<react_native_1.View style={styles.container}>
      {showBackBtn ? (<AntDesign_1.default name={'left'} color={'#ffffff'} size={Scale_1.scale(25)} onPress={onPressBackBtn}/>) : uid ? (<react_native_fast_image_1.default source={{
        uri: logo,
