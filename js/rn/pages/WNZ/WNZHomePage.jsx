...
var WNZHomePage = function () {
    ...
    if (loading) {
        ...
        }} onPressPromotion={goToJDPromotionListPage} debug={false} version={'tars'}/>
          <BottomGap_1.default />
