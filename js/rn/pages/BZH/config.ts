...
const config = {
  defaultUserCenterLogos: {
    ...
    8: 'https://appstatic.guolaow.com/assets/BZH/transferMoney.png', // 额度转换
    ...
    14: 'https://appstatic.guolaow.com/assets/BZH/service.png', // 在线客服
    15: getHtml5Image(21, 'center/money'), // 活动彩金
    16: 'https://appstatic.guolaow.com/assets/BZH/long.png', // 长龙助手
    17: getHtml5Image(21, 'center/menu-activity'), // 全民竞猜
    18: getHtml5Image(21, 'center/kj_trend'), // 开奖走势
    19: 'https://appstatic.guolaow.com/assets/BZH/qq.png', // QQ客服
    20: 'https://appstatic.guolaow.com/assets/BZH/award.png', // 開獎網
  },
}
