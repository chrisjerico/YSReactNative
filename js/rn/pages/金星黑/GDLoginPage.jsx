...
var errorTimes = 0;
var GDLoginPage = function (_a) {
    var route = _a.route, navigation = _a.navigation;
    var _b = react_hook_form_1.useForm(), control = _b.control, errors = _b.errors, triggerValidation = _b.triggerValidation, handleSubmit = _b.handleSubmit;
    ...
    return (<react_native_1.View style={{ backgroundColor: '#1a1a1e', flex: 1 }}>
      ...
      <react_native_1.ScrollView style={{ flex: 1, paddingHorizontal: 15 }}>
        <react_native_1.Text style={{ textAlign: 'left', color: 'white', fontSize: 30, marginTop: 10, marginBottom: 5, fontWeight: "bold" }}>欢迎你</react_native_1.Text>
        <react_native_1.Text style={{ textAlign: 'left', color: 'white', fontSize: 12, marginTop: 10, marginBottom: 20, fontWeight: "bold" }}>没有账号,立即<react_native_1.Text onPress={function () {
        RootNavigation_1.push(Navigation_1.PageName.GDRegisterPage);
    }} style={{ color: '#cfa461' }}> 注册 </react_native_1.Text>或<react_native_1.Text onPress={testPlay} style={{ color: '#cfa461' }}> 免费试玩 </react_native_1.Text></react_native_1.Text>
        <react_native_1.View style={{ backgroundColor: accountFocus ? "white" : '#34393c', height: 50, borderRadius: 4, borderColor: '#34393c', borderWidth: 0, flexDirection: 'row', alignItems: 'center' }}>
          <react_native_fast_image_1.default style={{ width: 14, height: 15, marginHorizontal: 15 }} tintColor={accountFocus ? 'black' : '#cfa461'} source={{ uri: "http://test10.6yc.com/images/icon-user.png" }}></react_native_fast_image_1.default>
          <react_native_1.View style={{ height: '40%', width: 1, backgroundColor: accountFocus ? '#8e8e93' : '#cfa461', marginRight: 5 }}></react_native_1.View>
          <react_hook_form_1.Controller onBlur={function () {
        setAccountFocus(false);
    }} onChange={function (args) {
        return args[0].nativeEvent.text;
    }} style={{ flex: 1, color: !accountFocus ? '#cfa461' : 'black' }} as={<react_native_1.TextInput placeholderTextColor={accountFocus ? '#8e8e93' : '#cfa461'} onFocus={function () {
        ...
        <react_native_1.View style={{ backgroundColor: pwdFocus ? "white" : '#34393c', height: 50, marginTop: 20, borderRadius: 4, borderColor: '#34393c', borderWidth: 0, flexDirection: 'row', alignItems: 'center' }}>
          <react_native_fast_image_1.default style={{ width: 14, height: 15, marginHorizontal: 15 }} tintColor={pwdFocus ? 'black' : '#cfa461'} source={{ uri: "http://test10.6yc.com/images/icon-pwd.png" }}></react_native_fast_image_1.default>
          <react_native_1.View style={{ height: '40%', width: 1, backgroundColor: pwdFocus ? '#8e8e93' : '#cfa461', marginRight: 5 }}></react_native_1.View>
          <react_hook_form_1.Controller onBlur={function () {
        setPwdFocus(false);
    }} onChange={function (args) {
        return args[0].nativeEvent.text;
    }} style={{ flex: 1, color: !pwdFocus ? '#cfa461' : 'black' }} as={<react_native_1.TextInput secureTextEntry={secureTextEntry} placeholderTextColor={pwdFocus ? '#8e8e93' : '#cfa461'} onFocus={function () {
        setPwdFocus(true);
    }}/>} name="pwd" rules={{
        required: {
        ...
        setSecureTextEntry(function (secureTextEntry) { return !secureTextEntry; });
            ...
            <react_native_elements_1.Icon name={secureTextEntry ? 'md-eye-off' : 'md-eye'} type="ionicon" size={22} color={pwdFocus ? "#8e8e93" : '#cfa461'} containerStyle={{ marginLeft: 15, marginRight: 4 }}/>
        ...
        marginTop: 20, justifyContent: 'center', alignItems: 'center'
            ...
            <react_native_1.Text style={{ color: "white", fontSize: 14 }}>登录</react_native_1.Text>
          </react_native_1.View>
        </react_native_1.TouchableWithoutFeedback>
        <react_native_1.TouchableWithoutFeedback onPress={function () {
        RootNavigation_1.pop();
        ...
        marginTop: 10, justifyContent: 'center', alignItems: 'center'
            ...
            <react_native_1.Text style={{ color: "white", fontSize: 14 }}>返回首页</react_native_1.Text>
          </react_native_1.View>
        </react_native_1.TouchableWithoutFeedback>
