    ...
    <View style={{flex: 1, backgroundColor: 'black'}}>
      ...
      <ScrollView refreshControl={
        ...
        <View style={{flex: 1, height: 223 / 375 * width, flexDirection: 'row',}}>
          <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 0)}>
            <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[0]?.icon}} style={{
              ...
              <Text style={{
                color: colorEnum.titleColor,
                fontSize: 16.5
              }}>{homeGames?.data?.icons?.[0]?.list?.[0]?.name}</Text>
              <Text style={{
                margin: 5,
                color: "rgba(167,171,179,.99)",
                fontSize: 12
              }}>{homeGames?.data?.icons?.[0]?.list?.[0]?.subtitle}</Text>
            </FastImage>
          </TouchableWithoutFeedback>
          ...
          <View style={{flexDirection: 'column', flex: 0.4, justifyContent: 'space-between', borderRadius: 10,}}>
            <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 1)}>
              <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[1]?.icon}} style={{
                flex: 6,
                marginBottom: 8,
                borderRadius: 10,
                paddingLeft: 5,
                ...
                <Text style={{
                  color: colorEnum.titleColor,
                  fontSize: 16.5
                }}>{homeGames?.data?.icons?.[0]?.list?.[1]?.name}</Text>
                <Text style={{
                  margin: 5,
                  color: "rgba(167,171,179,.99)",
                  fontSize: 12
                }}>{homeGames?.data?.icons?.[0]?.list?.[1]?.subtitle}</Text>
              </FastImage>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 2)}>
              <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[2]?.icon}} style={{
                flex: 4,
                borderRadius: 10,
                paddingLeft: 5,
                paddingTop: 10,
                ...
                <Text style={{
                  color: colorEnum.titleColor,
                  fontSize: 16.5
                }}>{homeGames?.data?.icons?.[0]?.list?.[2]?.name}</Text>
                <Text style={{
                  margin: 5,
                  color: "rgba(167,171,179,.99)",
                  fontSize: 12
                }}>{homeGames?.data?.icons?.[0]?.list?.[2]?.subtitle}</Text>
              </FastImage>
            </TouchableWithoutFeedback>
          </View>
        </View>
        <View style={{flexDirection: 'row', height: 136, marginTop: 10}}>
          <View style={{
            flex: 0.65,
            backgroundColor: colorEnum.gameitemBgColor,
            borderRadius: 10,
            marginRight: 8,
            padding: 5
          }}>
            ...
            <View style={{flex: 3, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center'}}>
              <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 3)}>
                <View style={{alignItems: 'center'}}>
                  <FastImage style={{width: 42, height: 42, borderRadius: 8, marginBottom: 10}}
                             source={{uri: homeGames?.data?.icons?.[0]?.list?.[3]?.icon}}/>
              ...
              <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 4)}>
                <View style={{alignItems: 'center'}}>
                  <FastImage style={{width: 42, height: 42, borderRadius: 8, marginBottom: 10}}
                             source={{uri: homeGames?.data?.icons?.[0]?.list?.[4]?.icon}}/>
              ...
              <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 5)}>
                <View style={{alignItems: 'center'}}>
                  <FastImage style={{width: 42, height: 42, borderRadius: 8, marginBottom: 10}}
                             source={{uri: homeGames?.data?.icons?.[0]?.list?.[5]?.icon}}/>
              ...
              <TouchableWithoutFeedback onPress={thirdPartGamePress.bind(null, 6)}>
                <View style={{alignItems: 'center'}}>
                  <FastImage style={{width: 42, height: 42, borderRadius: 8, marginBottom: 10}}
                             source={{uri: homeGames?.data?.icons?.[0]?.list?.[6]?.icon}}/>
          ...
          <TouchableWithoutFeedback style={_styles.buttonContainer} onPress={thirdPartGamePress.bind(null, 7)}>
            <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[7]?.icon}}
              ...
              <Text style={{
                color: colorEnum.titleColor,
                fontSize: 16.5
              }}>{homeGames?.data?.icons?.[0]?.list?.[7]?.name}</Text>
              <Text style={{
                margin: 5,
                color: "rgba(167,171,179,.99)",
                fontSize: 12
              }}>{homeGames?.data?.icons?.[0]?.list?.[7]?.subtitle}</Text>
            </FastImage>
          </TouchableWithoutFeedback>
        </View>
            ...
            <View style={_styles.buttonContainer}>
              <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[8]?.icon}}
                ...
                <Text style={{
                  color: colorEnum.titleColor,
                  fontSize: 12
                }}>{homeGames?.data?.icons?.[0]?.list?.[8]?.name}</Text>
                <Text style={{
                  color: "rgba(167,171,179,.99)",
                  fontSize: 12,
                  marginTop: 10
                }}>{homeGames?.data?.icons?.[0]?.list?.[8]?.subtitle}</Text>
              </FastImage>
            </View>
          </TouchableWithoutFeedback>
            ...
            <View style={_styles.buttonContainer}>
              <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[9]?.icon}}
                ...
                <Text style={{
                  color: colorEnum.titleColor,
                  fontSize: 12
                }}>{homeGames?.data?.icons?.[0]?.list?.[9]?.name}</Text>
                <Text style={{
                  color: "rgba(167,171,179,.99)",
                  fontSize: 12,
                  marginTop: 10
                }}>{homeGames?.data?.icons?.[0]?.list?.[9]?.subtitle}</Text>
              </FastImage>
            </View>
          </TouchableWithoutFeedback>
            ...
            <View style={_styles.buttonContainer}>
              <FastImage source={{uri: homeGames?.data?.icons?.[0]?.list?.[10]?.icon}}
                ...
                <Text style={{
                  color: colorEnum.titleColor,
                  fontSize: 12
                }}>{homeGames?.data?.icons?.[0]?.list?.[10]?.name}</Text>
                <Text style={{
                  color: "rgba(167,171,179,.99)",
                  fontSize: 12,
                  marginTop: 10
                }}>{homeGames?.data?.icons?.[0]?.list?.[10]?.subtitle}</Text>
              </FastImage>
            </View>
          </TouchableWithoutFeedback>
        </View>
