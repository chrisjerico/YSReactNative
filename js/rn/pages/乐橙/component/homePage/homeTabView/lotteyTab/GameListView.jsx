...
exports.GameListView = function (_a) {
    ...
    return (<react_native_1.FlatList style={{ flex: 1, borderTopColor: '#c7c7c7', borderTopWidth: 1 }} scrollEnabled={false} keyExtractor={function (item, index) { return "boardGame-" + index; }} numColumns={2} data={fillArray_1.fillArray(list, 2)} renderItem={function (_a) {
        var item = _a.item;
