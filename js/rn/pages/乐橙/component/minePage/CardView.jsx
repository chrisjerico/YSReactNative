...
exports.CardView = function () {
    ...
    return (<react_native_1.View style={{ height: 300, width: react_native_1.Dimensions.get("screen").width }}>
        ...
        paddingHorizontal: 6
                    ...
                    <react_native_1.TouchableWithoutFeedback style={{ flex: 1, alignItems: "flex-end" }} onPress={function () {
        PushHelper_1.default.pushUserCenterType(UGSysConfModel_1.UGUserCenterType.任务中心);
                ...
                <react_native_1.View style={{ paddingHorizontal: 50, paddingTop: 10, flexDirection: "row" }}>
                    ...
                    <react_native_1.TouchableWithoutFeedback onPress={function () { return setShowBalance(!showBalance); }}>
...
var CardButton = function (_a) {
    ...
    return (<react_native_1.TouchableWithoutFeedback onPress={onPress}>
            <react_native_1.View style={{ alignItems: "center", flex: 1 / 3, height: "100%" }}>
